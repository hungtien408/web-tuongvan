                ...
                <tr>
                    ...
                    <td class="invisible">
                        <asp:RadComboBox Filter="Contains" ID="ddlSearchCategory" runat="server" DataSourceID="ObjectDataSource2"
                            ...
                            Width="300px" EmptyMessage="- Tất cả -">
                        </asp:RadComboBox>
                    </td>
                    <td class="left invisible">
                        Nhà sản xuất
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 260px x 185px)</span>
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 900px x 639px)</span>
