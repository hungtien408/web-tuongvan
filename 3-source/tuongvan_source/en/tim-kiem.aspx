<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true"
    CodeFile="tim-kiem.aspx.cs" Inherits="danhmuc_thuong_mai" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphSite" runat="Server">
    <a href="thuong-mai.aspx">Commerce</a>/<span><asp:Label ID="lblTitle" runat="server"
        Text=""></asp:Label></span>
</asp:Content>
        ...
        <asp:ListView ID="lstCommerce" runat="server" DataSourceID="odsCommerce" EnableModelValidation="True">
            <ItemTemplate>
                <div class="col-md-4">
                    <div class="items">
                        <h4>
                            <a href='<%# progressTitle(Eval("ProductNameEn")) + "-pci-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductNameEn") %></a></h4>
                        ...
                        <div class="btn-detail">
                            <div class="btn-more">
                                <a href='<%# progressTitle(Eval("ProductNameEn")) + "-pci-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'>Details</a>
                            </div>
                            <div class="btn-price">
                                <a href='<%# progressTitle(Eval("ProductNameEn")) + "-bg-" + Eval("ProductID") + ".aspx" %>'>Price list</a>
                            </div>
                        </div>
                    </div>
                </div>
