...
function check_if_in_view() {
    ...
    $.each($animation_elements, function () {
        ...
        if ((element_bottom_position >= window_top_position) &&
            ...
            $(".it-tm").find(".slide-tm-1").stop(true, true).delay(1500).animate({
                right: '5%',
                opacity:'1'
            }, 1000, "easeOutQuart");

            $(".it-dv").find(".slide-dv-1").stop(true, true).delay(1500).animate({
                right: '36%',
                opacity: '1'
            }, 1000, "easeOutQuart");

            $(".it-dv").find(".slide-dv-2").stop(true, true).delay(1900).animate({
                right: '5%',
                opacity: '1'
            }, 1000, "easeOutQuart");
        //} else {
